...
# -*- coding: utf-8 -*-
"""
ELISA Benchmark v5.1 — DT3 Human Fetal Lung (Lim et al. EMBO J 2025)
=====================================================================
100 Queries — fdAT2 Organoid Model

Paper: "A novel human fetal lung-derived alveolar organoid model reveals
       mechanisms of surfactant protein C maturation relevant to
       interstitial lung disease"
       Lim et al., The EMBO Journal (2025) 44:639-664
...
NOTE: This dataset has only 5 clusters (Cell Ontology names), so top_k=5
and recall is evaluated at @1, @2, @3, @5.
